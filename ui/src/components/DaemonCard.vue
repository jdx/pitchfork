...
<template>
  <div class="card" @click="goDetail">
    ...
    <div class="card-actions" @click.stop>
      <button v-if="daemon.status.type === 'stopped' || daemon.status.type === 'failed' || daemon.status.type === 'errored' || daemon.status.type === 'available'" class="act-btn act-start" :disabled="isActing() || !!actionsDisabledReason" :title="actionsDisabledReason" @click="onStart">
