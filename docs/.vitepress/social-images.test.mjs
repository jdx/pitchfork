...
test("renders a self-contained 1200 by 630 PNG", () => {
  const dir = mkdtempSync(join(tmpdir(), "pitchfork-social-"));
  try {
...
test("built-page checks reject swapped images and empty alt text", () => {
  ...
  const page = (title, card, alt = title + " — pitchfork docs") => `
    <meta property="og:title" content="${title} | pitchfork">
    <meta name="twitter:title" content="${title} | pitchfork">
