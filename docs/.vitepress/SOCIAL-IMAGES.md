...
The docs build generates a 1200×630 PNG per page from its title and pitchfork's
master logo at `docs/public/img/logo.png`. The homepage uses a short product
description. The logo is downscaled with sharp; cards are rendered locally
with resvg and the bundled OFL-licensed Space Grotesk font;
