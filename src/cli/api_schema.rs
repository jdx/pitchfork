        ...
        let doc = ApiDoc {
            endpoints: vec![
                ...
                Endpoint {
                    path: "/api/projects",
                    method: "GET",
                    description: "List registered projects with worktree counts, daemon counts, and last activity.",
                    path_params: vec![],
                    query_params: vec![],
                    request_body: None,
                    response_type: Some("Vec<ApiProjectSummary>"),
                    auth: true,
                },
                Endpoint {
                    path: "/api/projects/{project}",
                    method: "GET",
                    description: "Show one project: every known worktree, including never-started ones, plus the primary checkout's stack.",
                    path_params: vec![Param {
                        name: "project",
                        type_name: "string",
                        description: "Registered project name (matched case-insensitively)",
                        required: true,
                    }],
                    query_params: vec![],
                    request_body: None,
                    response_type: Some("ApiProject"),
                    auth: true,
                },
                Endpoint {
                    path: "/api/projects/{project}/{worktree}",
                    method: "GET",
                    description: "Show one worktree's stack: the daemon groups declared for it and each member daemon's state. Read-only; it never starts a daemon.",
                    path_params: vec![
                        Param {
                            name: "project",
                            type_name: "string",
                        ...
                        Param {
                            name: "worktree",
                            type_name: "string",
                            description: "Worktree URL name or branch name",
                            required: true,
                        },
                    ],
                    query_params: vec![],
                    request_body: None,
                    response_type: Some("ApiStack"),
                    auth: true,
                },
                Endpoint {
